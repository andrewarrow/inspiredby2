div p-0 
  ...
  div flex flex-col md:flex-row space-x-9 items-start justify-center
    ...
    div mt-6 md:mt-0 w-full md:w-1/2 font-allan text-4xl text-white uppercase
      ...
      div w-3/4 mt-9
        div text-center bg-white text-black rounded-lg p-3
          Heart Rate Variability (HRV)
      div w-3/4 mt-9 ml-9
        div text-center bg-indigo-200 text-black rounded-lg p-3
          Oscillatory variability in milliseconds
      div w-3/4 mt-9 ml-18
        div text-center bg-rose-200 text-black rounded-lg p-3
